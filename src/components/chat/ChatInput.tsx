...
const ChatInput = ({ isDisabled }: ChatInputProps) => {
  ...
  const textareaRef = useRef<HTMLTextAreaElement>(null); // for auto focus for 2nd msg after sending the first one
          ...
          <div className="relative flex flex-col w-full flex-grow p-4">
            <div className="relative">
              <Textarea
                ...
                value={message}
                onKeyDown={(e) => {
                  //for submitting the message on enter
                  if (e.key === "Enter" && !e.shiftKey) {
                    //the 2nd condition is to stop submit on the other shortcut
                    e.preventDefault();
                    addMessage();
